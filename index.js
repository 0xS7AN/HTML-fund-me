...
function listenForTransactionMine(trasactionResponse, provider) {
    console.log(`Mining ${trasactionResponse.hash}...`)
    return new Promise((resolve, reject) => {
        provider.once(trasactionResponse.hash, (trasactionReceipt) => {
            console.log(
                `Completed with ${trasactionReceipt.confirmations} confirmations`
            )
            resolve()
        })
    })
